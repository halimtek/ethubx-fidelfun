...
progress: {
  ...
  am: {
    ...
    home: {
      ...
      title: "የአማርኛ ፊደልን ይማሩ።",
      description:
        "የአማርኛ ፊደላትን ይማሩ፣ ድምጻቸውን ያዳምጡ፣ መጻፍ ይለማመዱ እና አንድ የፊደል ቤተሰብ በአንድ ጊዜ ይማሩ፣በራስ መተማመንዎን ያዳብሩ።",
      ...
      thingsToLearn: "ለመማር የሚያስፈልጉህ",
      learnYourWay: "በሚመቻችሁ መንገድ ተማሩ",
