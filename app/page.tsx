          ...
          <div className="grid items-center gap-12 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="border-y border-stone-200 px-10 py-12 text-center sm:px-16">
                ...
                <Link
                  href="/trace?letter=ሀ"
                  className="mt-5 inline-flex items-center gap-2 text-sm font-black text-purple-700 hover:text-purple-900"
                >
            ...
            {features.map((feature) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="mt-5 inline-flex items-center gap-1 text-sm font-black text-purple-700">
                    {t.home.explore}
      ...
      <section className="shell px-4 py-16 sm:px-6 sm:py-24">
        <div className="grid items-center gap-12 lg:grid-cols-[0.8fr_1.2fr]">
          <div>
            ...
            <Link
              href="/learn"
              className="mt-7 inline-flex items-center gap-2 font-black text-purple-700 hover:text-purple-900"
            >
              {t.home.exploreAll}
